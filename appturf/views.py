...
from appturf.models import User
from appturf.models import Booking
...
def loged(request):
    try:
        ...
        if a.Password == request.POST['password']:
            ...
            return render(request,'loged.html',{'key':a.Username,'key2':a.Name,'key4':a.Place,'key5':a.Phone,'key6':a.Email})
